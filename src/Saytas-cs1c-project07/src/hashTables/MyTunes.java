...
public class MyTunes 
{
	...
	public MyTunes(SongEntry[] allSongs)
	{
		...
		// Returns the unique genre names found when populating genre table
	...
	public void testIDtable(String filename) 
	{
		...
		for (String idStr : idsToFind)
		{
			...
			try
			{
				// Wrapper class for a SongEntry object that compares
				// objects based on a song's integer id field.
