...
public class SuperMarket 
{
	...
	public void showFirstAndLastItem(String message)
	{
		...
		// Searches from the root of the tree and returns the minimum and maximum
	...
	protected void displayInventoryState(String message, boolean showTree)
	{
		...
		// Traverses the tree and displays all the nodes
		...
		// Traverses the tree and displays only nodes that have not been
		// lazily deleted. NOTE: Here, we call the public version.
