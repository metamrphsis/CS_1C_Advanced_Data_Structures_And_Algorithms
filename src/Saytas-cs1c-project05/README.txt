...
resources/
    ...
    RUN.txt
        - Console output of test file: resources/inventory_log.txt

    RUN_2.txt
        - Console output of test file: resources/inventory_short.txt

    RUN_3.txt
        - Console output of test file: resources/inventory_invalid_removal.txt

    RUN_3.txt (Extra Credit Portion Example Run)
        - Console output of test file: resources/resources/music_genre_subset.json
