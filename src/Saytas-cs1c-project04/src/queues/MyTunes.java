...
public class MyTunes 
{
	...
	// 		 The class Jukebox manages three objects of type Queue<String>
	...
	public MyTunes(String requestFile, SongEntry[] allSongs)
	{
		...
		// fillPlaylists() reads the test file
	...
	public static void main(String[] args) 
	{
		...
		// Tests Jukeboxs class by enqueu-ing songs in the different playlists.
		final String TESTFILE = "resources/tunes.txt";	// Directory path for plain-text file

		//final String TESTFILE = "resources/empty_tunes.txt";	// Directory path for empty text file
